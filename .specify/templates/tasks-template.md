...
**Tests**: Include automated test tasks for every behavior required by the
constitution or feature specification. If automation is explicitly deferred,
include a manual verification task with the reason and residual risk.
...
<!--
  ...
  - Constitution gates for code quality, testing, UX, performance, and
...
- [ ] T004 [P] Document applicable quality, UX, testing, and performance gates
      from the constitution in feature validation notes
